  ...
  <div class="fixed top-4 right-4 z-50 space-y-2 max-w-sm w-full">
    {#each $toasts as toast (toast.id)}
      <div
        ...
        class="rounded-lg border p-4 shadow-lg {getColorClasses(toast.type)}"
      >
        <div class="flex items-start">
          ...
          <div class="ml-4 flex-shrink-0">
            <button
              ...
              class="inline-flex rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-gray-600"
            >
              <span class="sr-only">Close</span>
              <svg class="h-5 w-5 opacity-60 hover:opacity-100" fill="currentColor" viewBox="0 0 20 20">
